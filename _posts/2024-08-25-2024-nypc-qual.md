...
[2017 KAIST 가을 대회 D. Dev, Please Add This!](https://www.acmicpc.net/problem/14737)([풀이](https://justicehui.github.io/ps/2020/09/29/BOJ14737/)), [2020 1차 선발고사 4번. 칠하기](https://www.acmicpc.net/problem/25011)([풀이](https://justicehui.github.io/koi/2022/04/14/2020tst/))를 풀면 도움이 될 수도 있습니다.
...
참고로, $(x, y)$를 $(x+y, x-y)$로 바꾸는 것은 회전 변환 $\begin{pmatrix}\cos 45\degree & -\sin 45\degree \\ \sin 45\degree & \cos 45\degree \end{pmatrix}\begin{pmatrix}x\\y\end{pmatrix} = \frac{\sqrt 2}{2} \begin{pmatrix} x - y \\ x + y  \end{pmatrix}$를 적용한 뒤 상수 배 한 것을 의미합니다.
...
HLD를 이용해 경로를 $O(\log N)$개의 부분 문자열로 표현한 뒤, 해싱이나 접미사 배열 + LCP 배열을 이용해 부분 문자열의 사전 순 비교를 할 수 있습니다.
