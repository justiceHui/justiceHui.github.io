...
## 서론
<img src="/img/20230504skku.png" style='width:50%'><br>
...
2026.01.19: 1/2룰 폐지와 Asia Pacific Championship에 대한 설명을 추가했습니다.
...
ICPC는 국제 결승의 역할을 하는 World Finals, WF 진출 팀을 선발하는 Regional Championship, 지역 예선의 역할을 하는 Regional Contest로 구성되어 있습니다. 한국 대학교 팀은 Asia Pacific 지역에서 열리는 Regional Contest에 참가할 수 있으며, 매년 조금씩 달라지지만 주로 대한민국(서울), 일본(요코하마), 인도네시아(자카르타), 대만(타오위안/타이중), 베트남(하노이/호치민/후에시티) 등에서 개최됩니다. Asia Pacific 지역에서 개최된 모든 Regional Contest에서 총 약 60팀 정도를 선발해 Asia Pacific Championship을 치루며, 여기에서 약 16팀 정도가 World Finals에 진출할 수 있습니다.

각 대회의 일정과 규칙은 아래 링크에서 확인할 수 있습니다.
* World Finals: [https://worldfinals.icpc.global/](https://worldfinals.icpc.global/)
* Asia Pacific: [https://icpc.jp/apac/](https://icpc.jp/apac/)
* Asia Pacific 리저널 점수 계산기: [https://icpcapac.solved.ac/](https://icpcapac.solved.ac/)
* 한국 리저널: [https://icpckorea.org/](https://icpckorea.org/)
* 일본 리저널: [https://icpc.jp/](https://icpc.jp/)
* 인도네시아 리저널: [https://competition.binus.ac.id/portal/](https://competition.binus.ac.id/portal/)
* 베트남 리저널: [https://acm-icpc.olp.vn/](https://acm-icpc.olp.vn/)

한국에서 열리는 Asia Seoul Regional Contest는 한국 대학생 프로그래밍 경시대회 본선을 겸하기 때문에 대통령상, 국무총리상, 장관상 등 높은 상들이 걸려있습니다.
...
<s>각 학교마다 예선 등록 팀 수의 절반 이하만 본선에 진출 가능하기 때문에 학교마다 본선 진출 커트라인이 다릅니다. ([링크](http://icpckorea.org/archives/2472)의 1/2 규칙 참고) 1/2 규칙을 만족하는 팀 중 n문제 이상 푼 대학 내 m등 팀을 본선에 올리는 방식으로 본선 진출 팀을 선정합니다. ICPC에서 좋은 성적을 내는 학교일수록 본선 진출이 어려운 편이며, 주로 `서울대학교 >>>>> 카이스트 = 고려대학교 >>> 서강대학교 = 성균관대학교 = 한양대학교 = 숭실대학교` 순으로 어렵습니다. 특히 서울대학교는 본선에 진출하면 수상이 거의 확정될 정도로 본선 진출 난이도가 높습니다.</s>

이 규칙은 2023년부터 사용되지 않습니다. 본선 진출 팀 선발 규정은 [https://icpckorea.org/](https://icpckorea.org/)에 있는 예선 경시 규칙을 참고하시길 바랍니다.

본선은 11월에 개최되며 5시간 동안 12문제를 해결해야 합니다. 예선과 다르게 본선은 모든 팀이 한 장소에 모여서 대회를 진행합니다. 대상 1팀, 금상 1팀, 은상 3팀, 동상 4팀, 장려상 5팀으로 총 14팀에게 시상하며, 매년 후원사 사정에 따라 특별상을 추가로 수여하는 것으로 보입니다.
